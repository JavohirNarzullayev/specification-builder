...
public class ReflectionUtils {
    ...
    public static <T> T extractFieldValue(Object classObj,
                                          String fieldName, Class<T> castObject
    ...
    public static LocalDate toLocalDate(
        ...
        if (LocalDate.class.equals(param.getClass())) {
            ...
            localDate = DateUtil.toLocalDate(param.toString(), DateUtil.FORMAT_LOCALDATE);
            if (localDate == null)
    ...
    public static Date toDate(
        ...
        Date date;
        if (Date.class.equals(param.getClass())) {
            date = (Date) param;
        } else {
            date = DateUtil.toDate(param.toString(), DateUtil.FORMAT_DATE);
            if (date == null)
                throw new SearchException("Date pattern should be 2020.05.14");
        }
        return date;
    }
    public static LocalDateTime toLocalDateTime(
        ...
        if (LocalDateTime.class.equals(param.getClass())) {
            ...
            localDateTime = DateUtil.toLocalDateTime(param.toString(), DateUtil.FORMAT_LOCALDATETIME);
        }
